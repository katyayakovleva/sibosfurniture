...
function sibosfurniture_scripts() {
	...
	wp_style_add_data( 'sibosfurniture-style', 'rtl', 'replace' );

	wp_enqueue_script( 'sibosfurniture-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
