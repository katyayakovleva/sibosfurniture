...
<!-- <form id="order_review" method="post"> -->
    ...
    <form>
		...
		<!-- <div class="form-row"> -->
			...
			<?php echo apply_filters( 'woocommerce_pay_order_button_html', '<button type="submit" class=" d-flex jc-center jc-sm-start mt-2 btn" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '">' . esc_html( $order_button_text ) . '</button>' ); // @codingStandardsIgnoreLine ?>
