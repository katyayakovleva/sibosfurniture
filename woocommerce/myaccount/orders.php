            ...
            <div class="orders-1__row">
                <?php foreach ( wc_get_account_orders_columns() as $column_id => $column_name ) : ?>
                    ...
                    <?php elseif ( 'order-number' === $column_id ) : ?>
                                    <p class="id"><?php echo esc_html( _x( '#', 'hash before order number', 'woocommerce' ) . $order->get_order_number() ); ?></p>
                    
                    <?php elseif ( 'order-date' === $column_id ) : ?>
                        <p class="date"><?php echo esc_html( wc_format_datetime( $order->get_date_created() ) ); ?></p>

                    <?php elseif ( 'order-status' === $column_id ) : ?>
                        <p class="status"><?php echo esc_html( wc_get_order_status_name( $order->get_status() ) ); ?></p>
...
<?php else : ?>
	<div class="no_orders">
        ...
        <div>
            <button class="btn" onclick="location.href = '<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>';">Browse products</button> 
        </div>
	</div>
<?php endif; ?>
